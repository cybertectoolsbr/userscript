...
| DoctorCondo - WhatsApp em janela | 0.4.5 | [Janela do WhatsApp](https://raw.githubusercontent.com/cybertectoolsbr/userscript/main/DoctorCondo-WhatsApp-Janela.user.js) |
...
- **Janela 0.4.5:** texto pequeno junto ao botão WhatsApp em tela larga; o modal de **Shift + clique** também mostra a versão no canto inferior direito.
...
## Botão Verificar atualização — 4.5.27 / 0.4.5 / 0.1.5
